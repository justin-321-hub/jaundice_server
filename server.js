...
/* =========================
   ...
   ========================= */
app.use(cors({
  origin: ['https://jaundice.smartchat.live','https://justin-321-hub.github.io','https://justin-321-hub.github.io/jaundice-test/'],
...
/* =========================
   ...
   ========================= */
app.post('/api/chat-clinical', verifyParentIdentity, async (req, res) => {
